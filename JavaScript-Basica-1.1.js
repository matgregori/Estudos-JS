...
plus1(y)                    // => 4: y é 3; portanto, essa chamada retirba 3+1
...
// Quando funções recebem as propriedades de um objeto, as chamamos de "métodos". Todos os objetos de 
// JavaScript têm métodos:
...
// o método é definido: neste caso, o array de pontos anteriror.
...
points.dist = function(){                   // Define um método para calcular a distância entre pontos
    ...
    return Math.sqrt(a * a + b * b);        // O teoremas de Pitágoras. Math.sqrt() calcula a raiz quadrada
}

points.dist()                               // => 1,414: distância entre nossos 2 pontos

// Algumas funções cujos corpos demonstram instruções de estruturas de controle JavaScript comuns:
// As instruções JavaScript incluem condicionais e laços que usam a sintaze das linguagens C, C++, Java e outras.
